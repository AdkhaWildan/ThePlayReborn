<x-app-layout>
    ...
    <div class=" py-10 mx-auto bg-primary container text-light" >
        <div class="mb-1 card rounded-3 bg-secondary border-0">
            <div class="row">
                <div class="col-3">
                    <img class="img-fluid w-100 h-60 m-2 rounded-3" src="{{ asset('images/games/' . $data->image) }}" alt="" style="object-fit: cover">
                </div>
                <div class="col-7 ">
                    <div class="mt-3">
                ...
                <div class="col-2">
                    <a type="button" class="d-flex btn bg-light align-bottom text-secondary  mr-4 mt-48 w-32" data-bs-toggle="modal" data-bs-target="#exampleModal">
