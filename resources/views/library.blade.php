                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="my-1 card bg-secondary text-white">
                                <div class="row">
                                    <div class="col-2 "> 
                                        <img src="{{ asset('images/games/' . $game->game->image) }}" class="img-fluid w-100 h-32 m-2 rounded-2" alt="product" style="object-fit:cover">
                                    </div>
                                    <div class="col-8 mt-2">
                                        <p class="h6">{{ $game->game->gamename }}</p>
                                        <p class="text-sm text-gray-400 mb-6" style="font-size:70%">{{ $game->game->genre }}</p>
                                        <p class="text-sm" style="font-size:80%">Developer: {{ $game->game->developer }}</p>
                                        <p class="text-sm" style="font-size:80%">Release Date: {{ $game->game->releasedate }}</p>
                                    </div>
                                </div>
                            </div>
                        </li>
